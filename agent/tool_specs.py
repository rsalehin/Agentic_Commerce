...
TOOL_SPECS: list[ToolSpec] = [
    ...
    ToolSpec(
        ...
        "Omitted scope fields default to the customer's stored mandate scope.",
        _schema(
            scope={
                "type": "object",
                "properties": {
                    "product_classes": {"type": "array", "items": {"type": "string"}},
                    "monthly_amount_max": {"type": "number"},
                    "one_off_amount_max": {"type": "number"},
                    "advice_allowed": {"type": "boolean"},
                },
            }
        ),
    ),
