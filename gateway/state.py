...
ALLOWED: dict[str, set[str]] = {
    ...
    # identify blocks/rejects from the pre-step state (resume re-runs identify).
    MANDATE_VALID: {IDENTIFIED, CUSTOMER_REQUIRED, REVIEW_REQUIRED, REJECTED},
    ...
    # Resume targets = the precondition state of every customer-resumable step,
    # incl. MANDATE_VALID so a re-run of `identify` (blocked_from=MANDATE_VALID) is legal.
    CUSTOMER_REQUIRED: {
        MANDATE_VALID,
        IDENTIFIED,
        SCREENED,
